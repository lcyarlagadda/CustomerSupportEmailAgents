...
class VectorStoreManager:
    ...
    def get_retriever(self, **kwargs):
        ...
        return self.vectorstore.as_retriever(
            search_kwargs={"k": kwargs.get("k", TOP_K_RESULTS)}
        )
...
if __name__ == "__main__":
    ...
    manager = VectorStoreManager()
    manager.initialize(force_recreate=False)
    
    test_query = "How do I create a new project?"
    print(f"\nTesting search with query: '{test_query}'")
    results = manager.similarity_search_with_score(test_query, k=3)
